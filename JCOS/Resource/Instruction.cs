    ...
    public override string ToString()
    {
      ...
      switch (code)
      {
        ...
        case 0x1200:
          ...
          break;
        case 0x1350:
          ret = "Skip next if " + code.ToString("X");
          break;
        case 0x1360:
          ret = "Skip next if2 " + code.ToString("X");
          break;
        case 0x1430:
          ret = "OR " + code.ToString("X");
          break;
        case 0x1510:
          ret = "PLAY_SEQUENCE " + code.ToString("X");
          break;
        case 0x1515:
          ret = "PLAY_SEQUENCE2 " + code.ToString("X");
          break;
        case 0x2000:
        ...
        case 0x2400:
          ...
          break;
        case 0x3010:
          ret = "RANDOM_START " + code.ToString("X");
          break;
        case 0x3020:
          ret = "RANDOM_UNKNOWN " + code.ToString("X");
          break;
        case 0x30FF:
          ret = "RANDOM_END " + code.ToString("X");
          break;
        case 0x4000:
      ...
      return code.ToString("X4") + " " + String.Format("[{0, -20}]", ret) + " [" + data2HexStr() + "]"/*+"\t"+ret*/;
    }
  }
}
